...
2.  TuitionCor will prompt user to select whether they would like to sort the list for students or tutors.
3.  User will enter either “s” for students or “t” for tutors or "e" for exit.
4.  TuitionCor will return a list of students or tutors based sorted by their locality.
+
Use case ends.
...
+
[none]
** 3a1. TuitionCor request for either "s" or "t" or "e" to be inputted.
