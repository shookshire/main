    ...
    public static Client[] getSampleStudents() {
        return new Client[] {
            new Client(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                ...
                getTagSet("friends"), new Location("north"), new Grade("pri2"), new Subject("math"),
                    new Category("s")),
            new Client(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                getTagSet("colleagues", "friends"), new Location("central"), new Grade("sec1"),
            ...
            new Client(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                ...
                getTagSet("neighbours"), new Location("north"), new Grade("pri2"), new Subject("physics"),
                    new Category("s")),
            new Client(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                getTagSet("family"), new Location("central"), new Grade("sec1"), new Subject("chemistry"),
                    new Category("s")),
            new Client(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"),
                getTagSet("classmates"), new Location("north"), new Grade("pri2"), new Subject("math"),
                    new Category("s")),
            new Client(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                new Address("Blk 45 Aljunied Street 85, #11-31"),
                getTagSet("colleagues"), new Location("central"), new Grade("sec1"), new Subject("physics"),
                    new Category("s"))
        };
    }
