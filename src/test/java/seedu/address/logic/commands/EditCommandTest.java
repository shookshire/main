...
public class EditCommandTest {
    ...
    public void execute_allFieldsSpecifiedUnfilteredList_success() throws Exception {
        ...
        expectedModel.updateClient(model.getFilteredStudentList().get(0), editedClient, new Category("s"));
    ...
    public void execute_someFieldsSpecifiedUnfilteredList_success() throws Exception {
        ...
        Client lastPerson = model.getFilteredStudentList().get(indexLastPerson.getZeroBased());
        ...
        Model expectedModel = new ModelManager(new AddressBook(model.getAddressBook()), new UserPrefs());
        expectedModel.updateClient(lastPerson, editedPerson, new Category("s"));
    ...
    public void execute_noFieldSpecifiedUnfilteredList_success() {
        ...
        Client editedClient = model.getFilteredStudentList().get(INDEX_FIRST_PERSON.getZeroBased());
    ...
    public void execute_filteredList_success() throws Exception {
        ...
        Client personInFilteredList = model.getFilteredStudentList().get(INDEX_FIRST_PERSON.getZeroBased());
    ...
    public void execute_duplicatePersonUnfilteredList_failure() {
        Client firstPerson = model.getFilteredStudentList().get(INDEX_FIRST_PERSON.getZeroBased());
    ...
    public void execute_duplicatePersonFilteredList_failure() {
        ...
        Client personInList = model.getAddressBook().getStudentList().get(INDEX_SECOND_PERSON.getZeroBased());
        EditCommand editCommand = prepareCommand(INDEX_FIRST_PERSON,
    ...
    public void executeUndoRedo_validIndexUnfilteredList_success() throws Exception {
        ...
        Client personToEdit = model.getFilteredStudentList().get(INDEX_FIRST_PERSON.getZeroBased());
        ...
        expectedModel.updateClient(personToEdit, editedPerson, new Category("s"));
    ...
    public void executeUndoRedo_validIndexFilteredList_samePersonEdited() throws Exception {
        ...
        expectedModel.updateClient(personToEdit, editedPerson, new Category("s"));
        assertNotEquals(model.getFilteredStudentList().get(INDEX_FIRST_PERSON.getZeroBased()), personToEdit);
    ...
    public void equals() throws Exception {
        ...
        assertFalse(standardCommand.equals(new EditCommand(INDEX_SECOND_PERSON, DESC_AMY, new Category("s"))));

        // different descriptor -> returns false
        assertFalse(standardCommand.equals(new EditCommand(INDEX_FIRST_PERSON, DESC_BOB, new Category("s"))));
    }
    ...
    private EditCommand prepareCommand(Index index, EditPersonDescriptor descriptor) {
        EditCommand editCommand = new EditCommand(index, descriptor, new Category("s"));
