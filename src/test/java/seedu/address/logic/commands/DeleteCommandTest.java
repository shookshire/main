...
public class DeleteCommandTest {
    ...
    public void execute_validIndexUnfilteredList_success() throws Exception {
        Client personToDelete = model.getFilteredStudentList().get(INDEX_FIRST_PERSON.getZeroBased());
        DeleteCommand deleteCommand = prepareCommand(INDEX_FIRST_PERSON);

        String expectedMessage = String.format(DeleteCommand.MESSAGE_DELETE_CLIENT_SUCCESS, personToDelete);

        ModelManager expectedModel = new ModelManager(model.getAddressBook(), new UserPrefs());
        expectedModel.deleteClient(personToDelete, new Category("s"));
    ...
    public void executeUndoRedo_validIndexFilteredList_samePersonDeleted() throws Exception {
        ...
        expectedModel.deleteClient(personToDelete, new Category("s"));
        assertNotEquals(personToDelete, model.getFilteredStudentList().get(INDEX_FIRST_PERSON.getZeroBased()));
    ...
    private DeleteCommand prepareCommand(Index index) {
        DeleteCommand deleteCommand = new DeleteCommand(index, new Category("s"));
